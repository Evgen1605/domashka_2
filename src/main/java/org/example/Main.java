...
public class Main {
    public static void main(String[] args) {
        ...
        builder2.delete(0,2); // Удаление символов с 0 по 1 индекс включительно из builder2
        builder2.delete(builder2.length()-2,builder2.length()); // Удаление символов с builder2.length() - 2 индекса по builder2.length() - 1 индекс включительно из builder2
        changeSymbol(builder2, "\"", "");  // Замена символов "\"" на пустую строку в builder2
        changeSymbol(builder2, ":", "="); // Замена символов ":" на "=" в builder2

        while (builder2.indexOf("null")!=-1){ // В цикле, пока в builder2 есть вхождения строки "null"
            if(builder2.lastIndexOf(",", builder2.indexOf("null")) == -1){ // Если последний символ "null" в builder2 находится перед запятой
                builder2.delete(0, builder2.indexOf("null")+5); // Удалить символы с начала до конкретного вхождения "null" включительно
            }
            else {
        ...
        System.out.println(builder1.append(builder2)); // Вывод результата объединения builder1 и builder2 на экран
    }
